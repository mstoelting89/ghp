...
class partial_PageLayout_Grid_ColumnHeader_3bdafc5186326edfb0a85bfa817a85dcf0d5569e extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output86 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('newContentTitleShort', $array97)]);
