...
class partial_PageLayout_Record_ec5cce4fe0fd81bef93666bc287d6a5f55198f18 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output52 .= '" class="btn btn-default btn-sm t3js-toggle-new-content-element-wizard disabled">
                ';
...
$arguments59['identifier'] = 'actions-add';

$output52 .= TYPO3\CMS\Core\ViewHelpers\IconViewHelper::renderStatic($arguments59, $renderChildrenClosure60, $renderingContext);

$output52 .= '
                ';
$array61 = array (
);
$output52 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.newContentAfterTitle', $array61)]);
