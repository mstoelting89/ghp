...
class Standard_action_index_b565564efb1452690e78980444a8796c6ea6572d extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('sidebarcontent', $array46)]);
...
$array49 = array (
);return $renderingContext->getVariableProvider()->getByPath('footerLabel', $array49);
};
$arguments47 = array();
$arguments47['value'] = NULL;

$output0 .= isset($arguments47['value']) ? $arguments47['value'] : $renderChildrenClosure48();
...
$array52 = array (
);return $renderingContext->getVariableProvider()->getByPath('footerPartners', $array52);
};
$arguments50 = array();
...
$array55 = array (
);return $renderingContext->getVariableProvider()->getByPath('footerSecondaryMenu', $array55);
};
$arguments53 = array();
