...
class Standard_action_index_b857abec312c6d965626837a226b2b7c402e74fe extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array51 = array (
);return $renderingContext->getVariableProvider()->getByPath('contentNavigation', $array51);
};
$arguments49 = array();
$arguments49['value'] = NULL;

$output45 .= isset($arguments49['value']) ? $arguments49['value'] : $renderChildrenClosure50();
...
$array29 = array (
);return $renderingContext->getVariableProvider()->getByPath('contentNavigation', $array29);
};
$arguments27 = array();
...
$arguments52['partial'] = 'Nav/Sidebars';
